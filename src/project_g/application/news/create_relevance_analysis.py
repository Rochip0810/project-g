...
class CreateNewsRelevanceAnalysis:
    def __init__(
        self,
        *,
        repository: NewsRelevanceAnalysisRepository,
    ...
    def execute(
        ...
        if existing is not None:
            raise NewsRelevanceAnalysisAlreadyExistsError(intake_id)

        analysis = NewsRelevanceAnalysis.pending(
