...
HOCHI_GIANTS_LIST_URL = "https://hochi.news/tag/%E5%B7%A8%E4%BA%BA"

_ARTICLE_PATH_PATTERN = re.compile(
    r"^/articles/"
    r"(?P<external_id>[0-9]{8}-OHT1T[0-9]+)"
    r"\.html$"
)
...
class HochiGiantsArticlesParser:
    def parse(
        self,
        html: str,
        *,
    ...
    def _extract_title(
        ...
        return _DATETIME_PATTERN.sub(
            "",
            text,
        ).strip()


class HochiGiantsArticlesCollector:
    ...
    def __init__(
        ...
        *,
        ...
        self._clock = clock
        self._logger = get_logger("project_g.collectors.hochi_giants_articles")
