...
def test_initial_head_revision_is_available() -> None:
    ...
    assert get_head_revision(config) == "0010_narration_audio"
...
def test_upgrade_to_head_and_downgrade_to_base(
    ...
    try:
        ...
        assert get_current_revision(engine) == "0010_narration_audio"
...
def test_offline_upgrade_generates_sql() -> None:
    ...
    assert "0008_news_script_generations" in generated_sql
